...
from .PowerGrid    import get_powergrid  # <--- NUOVO

logger = logging.getLogger(__name__)

class DatasetFactory:
    '''
    Server as a factory for user to get benchmark dataset.
    This class provides a unified interface to access the basic datasets.
    '''
